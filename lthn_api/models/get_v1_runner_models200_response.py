...
class GetV1RunnerModels200Response(BaseModel):
    """
    GetV1RunnerModels200Response
    """ # noqa: E501
    data: Optional[GetV1RunnerModels200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GetV1RunnerModels200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
